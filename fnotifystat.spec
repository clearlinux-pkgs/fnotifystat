...
Version  : 0.03.00
Release  : 7
URL      : https://github.com/ColinIanKing/fnotifystat/archive/V0.03.00/fnotifystat-0.03.00.tar.gz
Source0  : https://github.com/ColinIanKing/fnotifystat/archive/V0.03.00/fnotifystat-0.03.00.tar.gz
...
%prep
%setup -q -n fnotifystat-0.03.00
cd %{_builddir}/fnotifystat-0.03.00
pushd ..
cp -a fnotifystat-0.03.00 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719963249
